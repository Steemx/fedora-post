...
if /usr/bin/rpm -q firewalld &>/dev/null; then
    firewall-cmd --permanent --add-service=kdeconnect 2>/dev/null || true
...
# 13. OPTIMIZACIÓN AVANZADA DE KDE
...
sudo -u "$REAL_USER" bash -c '
    ...
    kwriteconfig5 --file ~/.config/kwinrc --group Plugins --key kwin4_effect_dimscreenEnabled false
    kwriteconfig5 --file ~/.config/kwinrc --group Plugins --key kwin4_effect_fadedesktopEnabled false
    kwriteconfig5 --file ~/.config/kwinrc --group Plugins --key kwin4_effect_scaleinEnabled false
    kwriteconfig5 --file ~/.config/kwinrc --group Plugins --key kwin4_effect_squashEnabled false
    kwriteconfig5 --file ~/.config/kwinrc --group Plugins --key kwin4_effect_zoomEnabled false
    kwriteconfig5 --file ~/.config/kwinrc --group Plugins --key kwin4_effect_slideEnabled false
    kwriteconfig5 --file ~/.config/kwinrc --group Plugins --key kwin4_effect_fadeEnabled false
    kwriteconfig5 --file ~/.config/kwinrc --group Plugins --key kwin4_effect_coverEnabled false
    kwriteconfig5 --file ~/.config/kwinrc --group Plugins --key kwin4_effect_glideEnabled false
    ...
    kwriteconfig5 --file ~/.config/kwinrc --group Windows --key DesktopSwitchingAnimation 0
    # Configurar Dolphin sin previsualizaciones
    kwriteconfig5 --file ~/.config/dolphinrc --group General --key ShowThumbnails false
    kwriteconfig5 --file ~/.config/dolphinrc --group General --key PreviewSettings "application/octet-stream"
    # Desactivar animaciones del panel
    kwriteconfig5 --file ~/.config/plasmashellrc --group General --key animate 0
    # Desactivar efectos de apertura de ventanas
    kwriteconfig5 --file ~/.config/kwinrc --group Windows --key WindowOpenCloseAnimation 0
    # Aplicar cambios
