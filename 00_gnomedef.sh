#!/usr/bin/env bash
# ==============================================================================
# SCRIPT 1: SISTEMA BASE GNOME MINIMAL - FEDORA 44 (BLINDADO)
...
# 4. GNOME MINIMAL (+ dbus-x11 para gsettings, ptyxis en lugar de gnome-terminal)
...
# 5. ELIMINAR BLOATWARE (PROTEGIDO: --noautoremove evita que borre Nautilus)
...
# 9. CÓDECS Y DRIVERS INTEL (CORREGIDO: sin libvdpau-va-gl, con --skip-unavailable)
